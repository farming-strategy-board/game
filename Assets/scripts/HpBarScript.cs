...
public class HpBarScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject[] t_objects = GameObject.FindGameObjectsWithTag("Infantry");
    ...
    void Update()
    {
        ...
        {
            m_hpBarList[i].transform.position = m_cam.WorldToScreenPoint(m_objectList[i].position + new Vector3(0, 0.5f, 0));
        }
    }
}
